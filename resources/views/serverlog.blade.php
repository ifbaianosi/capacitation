...
<section class="engine"><a rel="external" href="#">SisCap</a></section><section class="mbr-section article mbr-parallax-background mbr-after-navbar" id="msg-box8-a" style="background-image: url(assets/images/mbr-1-2000x1333.jpg); padding-top: 180px; padding-bottom: 10px;">
    <div class="mbr-overlay" style="opacity: 0.5; background-color: rgb(34, 34, 34);">
    </div>
</section>
<section class="engine"><a rel="external" href="#">Link</a></section><section class="mbr-section mbr-after-navbar" id="msg-box5-f" style="background-color: rgb(255, 255, 255); padding-top: 10px; padding-bottom: 10px;">
    <div class="container">
        <div class="row">
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell col-md-5 text-xs-center text-md-right content-size">
                  <h3 class="mbr-section-title display-2"><br>REGISTROS DE SERVIDORES</h3>
                  <div class="lead">
							...
							<form class="form-horizontal" role="form">
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<input type="text" class="form-control" placeholder="Insira o nome ou SIAPE"/>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="submit" class="btn btn-default glyphicon glyphicon-edit">
											Pesquisar
										</button>
									</div>
								</div>
